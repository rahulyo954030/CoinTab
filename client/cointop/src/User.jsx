...
const User = () => {
  ...
  const getDataFunction = () => {
    axios
      .get(`https://rahul-singh-cointab-assignment.onrender.com/user?page=${pageNumber}`)
      .then((res) => {
  ...
  const filterByGender = (e) => {
    axios
      .get(`https://rahul-singh-cointab-assignment.onrender.com/user/search/${e.target.value}`)
      .then((res) => {
        setdata(res.data);
